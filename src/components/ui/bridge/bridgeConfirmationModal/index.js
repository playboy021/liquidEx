                                ...
                                <Dialog.Panel className="w-full max-w-md  p-5 mb-8 ml-1 mr-1 overflow-hidden text-left align-middle transition-all transform rounded-2xl lightBlueGlass bridgeTokenSearchGlow" style={{
                                    ...
                                    <div className='rounded-[12px] borderBrdgConfirm'>
                                        ...
                                        {transactionMode == true ?
                                            <div className='flex justify-between mt-2 mb-2 ml-2 mr-2' style={{ fontSize: '15px' }}>
                                                ...
                                                {/* {APIstatus.info?.swaptx == undefined ?
                                                    <div><b>...</b></div>
                                                    :
                                                    <div><a href={`${chainInfo[bridgedTo]?.explorer.tx}${APIstatus.info?.swaptx}`} target='_blank' rel="noreferrer"><b>{(APIstatus.info?.swaptx)?.slice(0, 6) + '...' + (APIstatus.info?.swaptx)?.slice(60, 66)}</b></a></div>} */}
                                        ...
                                        <div className='flex justify-between mt-2 mb-2 ml-2 mr-2' style={{ fontSize: '15px' }}>
                                            ...
                                            {/* <div><a href={`${chainInfo[bridgedTo]?.explorer.address}${account}`} target='_blank' rel="noreferrer"><b>{account?.slice(0, 6) + '...' + account?.slice(38, 42)}</b></a></div> */}
                                        </div>
                                    </div>
                                    {transactionMode == true ?
                                        null :
