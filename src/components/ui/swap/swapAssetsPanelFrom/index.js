            ...
            if (account != null) {
                ...
                if (tokens[srcToken]?.address == "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee") {
                    ...
                    try {
                        if (srcToken != null) {
                            try {
                                let Token = new ethers.Contract(tokens[srcToken]?.address, ERC20ABI, fromAddress)
        ...
        <>
            <div className='text-2xl leading-7 tracking-[-0.01em] relative flex items-baseline flex-grow gap-3 font-bold'>
                ...
                <div className='text-sm leading-5 absolute mt-8 text-secondary top-margin hover:shadow-md rounded-lg px-1' style={{ top: '20px' }}>
                        <div className='pt-2 cursor-pointer' onClick={() => {setSrcAmount(selectedTokenBalance)}}
                        >
...
SwapAssetsPanelFrom.Header = SwapAssetsPanelFromHeader
SwapAssetsPanelFrom.Panel = InputPanel

export default SwapAssetsPanelFrom
